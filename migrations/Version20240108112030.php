 ...
 */
final class Version20240108112030 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE navire (id INT AUTO_INCREMENT NOT NULL, idaisshiptype INT NOT NULL, idpays INT NOT NULL, idport INT DEFAULT NULL, imo VARCHAR(7) NOT NULL, nom VARCHAR(100) NOT NULL, mmsi VARCHAR(9) NOT NULL, indicatifappel VARCHAR(10) NOT NULL, eta DATETIME NOT NULL, longueur INT NOT NULL, largeur INT NOT NULL, tirantdeau DOUBLE PRECISION NOT NULL, INDEX IDX_EED103839F5FA88 (idaisshiptype), INDEX IDX_EED1038E750CD0E (idpays), INDEX IDX_EED1038905EAC6C (idport), INDEX ind_IMO (imo), INDEX ind_MMSI (mmsi), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
